    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto py-8 px-4 lg:py-12">
        <div className="grid gap-8 lg:grid-cols-12">
          {/* Left Column: Patient Profile & Visualization */}
          <div className="lg:col-span-5 space-y-8">
            ...
            <Card className="border-none glass shadow-xl overflow-hidden">
              <CardHeader>
                <CardTitle className="text-xl font-headline text-center">Multimodal Recovery Visualization</CardTitle>
              </CardHeader>
          ...
          {/* Right Column: Detailed Advice & Recommendations */}
          <div className="lg:col-span-7 space-y-8">
            <div className="flex flex-col gap-2">
              ...
              <p className="text-muted-foreground max-w-xl">
                Based on your federated health input, Zera has synthesized a structured recovery plan across four critical domains.
              </p>
            </div>
      ...
      <footer className="py-12 border-t bg-secondary/20">
        <div className="container mx-auto px-4 text-center">
          <p className="text-xs text-muted-foreground uppercase tracking-widest font-medium">
            AI Zera • Multimodal Deep Learning Research Dashboard
          </p>
        </div>
      </footer>
    </div>
